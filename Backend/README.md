...
cd avaliacao-Gestao_de_Centro_Esportivo/Backend
npm install
```

> Este projeto NestJS vive na pasta `Backend/` de um monorepo. Todos os comandos deste README (`npm run ...`, `npx prisma ...`) devem ser executados de dentro de `Backend/`.
